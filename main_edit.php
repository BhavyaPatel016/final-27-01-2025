...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $update_sql)) {
        ...
        header("Location: main_history.php"); // Redirect to the maintenance history page
    } else {
...
<body>
        ...
        <div class="form-container">
            <form method="POST">
                ...
                <div class="input-container">
                    ...
                    <input type="number" name="maintenance_amount" id="maintenance_amount" value="<?php echo $row['maintenance_amount']; ?>" required onchange="updateTotalAmount()">
                </div>
                ...
                <!-- Button Container with Update and Back buttons -->
                <div class="button-container">
                    <button type="submit" class="update-button">Update Record</button>
                    <a href="main_history.php"><button type="button" class="back-button">Back</button></a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        // Initialize the total amount calculation when the page loads
