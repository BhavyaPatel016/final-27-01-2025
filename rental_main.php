...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_sql = "INSERT INTO maintenance (flat_no, name, phone, email, payment_duration, start_date, end_date, amount, payment_method) 
                   VALUES ('$flatNo', '$userName', '$userNumber', '$userEmail', '$paymentDuration', '$startDate', '$endDate', '$maintenanceAmount', '$paymentMethod')";
    ...
    <div class="main-content">
        ...
        <form method="POST">
            <div class="maintenance-info">
                ...
                <p id="total-amount" class="font-bold text-lg">Total Amount: ₹<?php echo $maintenanceAmount; ?></p>
                <p>Payment Duration: <strong><?php echo $paymentDuration; ?></strong></p>
                <p>Starting Date: <strong><?php echo $startDate; ?></strong></p>
                <p>Ending Date: <strong><?php echo $endDate; ?></strong></p>
            </div>
